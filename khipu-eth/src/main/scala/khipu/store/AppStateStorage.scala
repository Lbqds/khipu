...
import khipu.store.trienode.PruningMode.PruneFn
...
final class AppStateStorage(val source: DataSource, pruneFn: PruneFn) extends KeyValueStorage[Key, String, AppStateStorage] {
